...
export const usePOSStore = defineStore('pos', () => {
  ...
  async function closeShift(countedCash, notes) {
    const z = await api.closeShift(shift.value.shift, countedCash, notes)
    shift.value = null
    return z
  }
  ...
  return {
    ...
    theme, setTheme,
    shift, shiftLoading, businessDate, loadShift, openShift, cashMovement, fetchXReport, closeShift, runDayClose,
    ...
    tender, clearTender, submitSale, buildReceipt, routeCartToStations, buildKotTicket,
